...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/aug10-NLOexa-rew-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_exact = plot
        plot_mass = plot.replace("NLOexa","NLOmas")
        plot_soft = plot.replace("NLOexa","NLOsoft")
        plot_novirt = plot.replace("NLOexa","NLOnovirt")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_exact,{"format" : "histogram", "label" : "NLO_{LHE} (exact)","line_style" : 1})
        gnu.add_curve(plot_mass,{"format" : "histogram", "label" : "NLO_{LHE} (MA)","line_style" : 3})
        gnu.add_curve(plot_soft,{"format" : "histogram", "label" : "NLO_{LHE} (SA)","line_style" : 2})
