...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/sep4-NLO13TeV-exa-run/distributions/*.dat"))
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        ...
        gnu.add_curve(plot_comb,{"format" : "histogram", "label" : "NLO_{PS} (CA)","line_style" : 3})
        gnu.add_curve(plot_combet,{"format" : "histogram", "label" : "NLO_{PS} (CA, error estim)","line_style" : 2})
