...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/sep19mQQF-NLO13TeV-exa-run/distributions/*.dat"))
...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        plot_exact = plot
        plot_comb = plot.replace("exa","combexp")
        plot_combet = plot.replace("exa","combexp-et")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        ...
        gnu.add_curve(plot_comb,{"format" : "histogram", "label" : "NLO+PS (CA, 7pt-sv)","line_style" : 3})
        gnu.add_curve(plot_combet,{"format" : "histogram", "label" : "NLO+PS (CA, 1l-unc)","line_style" : 2})
