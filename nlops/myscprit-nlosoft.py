...
#        plot_MATRIX_NNLO_31_inclusive_sumET = plot
        ...
        plot_soft = plot.replace("jun8-exactNLO","jun11-softNLO")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        gnu.add_curve(plot_exact,{"format" : "histogram", "label" : "NLO_{PS} (exact, LHE)","line_style" : 1})
        gnu.add_curve(plot_novirt,{"format" : "histogram", "label" : "NLO_{PS} (H1=0, LHE)","line_style" : 3})
        gnu.add_curve(plot_soft,{"format" : "histogram", "label" : "NLO_{PS} (H1=soft, LHE)","line_style" : 2})
