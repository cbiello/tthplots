...
set style line 3 dt (9,6) lc rgb \"violet\" lw 1
set style line 4 dt (9,6) lc rgb \"black\" lw 1
set style line 13 dt (8,4,8,4,3,4) lc rgb \"violet\" lw 0.1
...
set style line 1 lc rgb \"sienna4\" lw 1                                                                                                                                 
set style line 11 dt (8,4,8,4,3,4) lc rgb \"sienna4\" lw 0.1
...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/sep20-0A-kQ025-py8btlvio-run/distributions/*.dat"))
#    all_plots = glob.iglob(pjoin(os.getcwd(),"run_nnpdf31_new_kq05_inclusive_lhef-run/distributions/*.dat"))
    ...
    for plot in all_plots:
        ...
        plot_minnloH20 = plot
        plot_minnloH2MALC = plot.replace("0A","MALC")
        plot_minnloH2MAFC = plot.replace("0A","MAFC")
...
#        gnu.add_curve(plot_minnlopt,{"format" : "histogram", "label" : "MiNNLO K_Q=0.25 (LHE)","line_style" : 1})
        ...
        gnu.add_curve(plot_minnloH2MALC,{"format" : "histogram", "label" : "MiNNLO_{PS} (MA_{LC})","line_style" : 3})
        gnu.add_curve(plot_minnloH2MAFC,{"format" : "histogram", "label" : "MiNNLO_{PS} (MA_{FC})","line_style" : 1})
...
#            gnu.add_curve(plot_MATRIX_NNLO_30,{"format" : "histogram", "label" : "MATRIX 30","line_style" : 4})
        ...
        gnu.set_plot_properties("ymin_ratio",0.75)
...
#            gnu.set_plot_properties("rebin",1)
        ...
        if gnu.get_name().startswith("ptHiggs"):
            ...
            gnu.set_plot_properties("xmax",700)
