...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/oct7-SA-kQ025rw-scales-run/distributions/*.dat"))
...
#        plot_exact = plot
        plot_scales = plot
        plot_eta2 = plot.replace("scales","eta2")
        plot_etaH = plot.replace("scales","etaH")
...
#        gnu.add_curve(plot_exact,{"format" : "histogram", "label" : "NLO_{PS} (exact)","line_style" : 1})
        gnu.add_curve(plot_scales,{"format" : "histogram", "label" : "MiNNLO_{PS} (SA)","line_style" : 2})
        gnu.add_curve(plot_eta2,{"format" : "histogram", "label" : "MiNNLO_{PS} (SA, 2Q)","line_style" : 6})
