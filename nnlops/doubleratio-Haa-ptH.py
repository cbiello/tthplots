...
#{{{ def: get_gnuplot_settings_main_frame(self)
    def get_gnuplot_settings_main_frame(self):
        ...
        settings_main_frame = """
## define line styles        
#MiNNLO two-loop error
set style line 1 lc rgb \"dark-blue\" lw 1
set style line 11 lc rgb \"dark-blue\" lw 0.2 dt solid
#MiNNLO scale variation
set style line 2 lc rgb \"blue\" lw 1                                    
set style line 12 lc rgb \"blue\" lw 0.05
#NLOPS scale variation
set style line 3 lc rgb \"brown\" lw 1
set style line 13 lc rgb \"brown\" lw 0.05
#NLOPS CA one-loop error
set style line 5 lc rgb "#501450" lw 1
set style line 15 lc rgb "#501450" lw 0.2
#NLOPS CA scale variation
set style line 6 lc rgb \"dark-violet\" lw 1
set style line 16 lc rgb \"dark-violet\" lw 0.05
...
set arrow from 463, graph -0.04 to 473, graph 0.04 nohead lw 1 lc rgb "black"
set arrow from 468, graph -0.04 to 478, graph 0.04 nohead lw 1 lc rgb "black"
set mxtics %(mxtics)s
...
#            gnu.set_plot_properties("rebin",1)
        ...
        if gnu.get_name().startswith("PTH"):
            ...
            gnu.set_plot_properties("xmax",550)
            gnu.set_plot_properties("xtics_add",'("" 500, "∞" 550)')
