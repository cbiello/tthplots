...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/sep15-intermCA-scales-run/distributions/*.dat"))
...
#        plot_exact = plot
        plot_comb = plot
        plot_0A = plot.replace("sep15-intermCA-scales","sep20-0A-kQ025-py8btlvio")
