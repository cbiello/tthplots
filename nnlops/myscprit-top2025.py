...
#    all_plots = glob.iglob(pjoin(os.getcwd(),"MATRIX_NNLO_31_inclusive_sumETscale-run/distributions/*.dat"))
    all_plots = glob.iglob(pjoin(os.getcwd(),"datfiles/sep24-intermCALC-scales-run/distributions/*.dat"))
...
#        plot_exact = plot
        plot_comb = plot
        plot_0A = plot.replace("sep24-intermCALC-scales","sep20-0A-kQ025-py8btlvio")
#        plot_combet = plot.replace("scales","error")
...
#        gnu.add_curve(plot_exact,{"format" : "histogram", "label" : "NLO_{PS} (exact)","line_style" : 1})
        gnu.add_curve(plot_comb,{"format" : "histogram", "label" : "MiNNLO_{PS} (CA)","line_style" : 2})
        gnu.add_curve(plot_0A,{"format" : "histogram", "label" : "MiNNLO_{PS} (0A)","line_style" : 6})
#        gnu.add_curve(plot_combet,{"format" : "histogram", "label" : "MiNNLO_{PS} (CA, error estim)","line_style" : 2})
...
#            gnu.set_plot_properties("rebin",1)
        ...
        if gnu.get_name().startswith("yHiggs"):
            ...
            gnu.set_plot_properties("rebin",1)
            gnu.set_plot_properties("ymax",200)
            gnu.set_plot_properties("legend","down center")
